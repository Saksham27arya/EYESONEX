...
model_path = "/home/HimanshuRana/Desktop/testss/models/vosk-model-small-en-us-0.15/"
...
#     tts.save("/home/HimanshuRana/Desktop/testss/output.wav")
#     pygame.mixer.music.load("/home/HimanshuRana/Desktop/testss/output.wav")
#     pygame.mixer.music.play()
#     while pygame.mixer.music.get_busy():
#         pygame.time.Clock().tick(10)
#     os.remove("/home/HimanshuRana/Desktop/testss/output.wav")
def speak(text):
    tts = gTTS(text=text, lang='en')
    mp3_path = "/home/HimanshuRana/Desktop/testss/output.mp3"
    tts.save(mp3_path)
...
def object_detection_and_distance():
    ...
    Distance_level = 0
    classNames = []
    with open('/home/HimanshuRana/Desktop/testss/coco.names', 'r') as f:
        classNames = f.read().splitlines()
    print(classNames)
    Colors = np.random.uniform(0, 255, size=(len(classNames), 3))

    weightsPath = "/home/HimanshuRana/Desktop/testss/frozen_inference_graph.pb"
    configPath = "/home/HimanshuRana/Desktop/testss/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"

    face_model = cv2.CascadeClassifier('/home/HimanshuRana/Desktop/testss/haarcascade_frontalface_default.xml')
    ...
    ref_image = cv2.imread("/home/HimanshuRana/Desktop/testss/lena.png")
...
def main():
    ...
    while True:
        ...
        try:
            if 'check' in query or 'jack' in query:
